<template>
  <q-dialog :model-value="modalSignIn" @@before-hide="closeModal" @update:model-value="handleDialogUpdate">
    <q-card style="width: 420px" class="q-pa-sm">
      ...
      <q-card-section>
        <q-form @submit="handleSubmit">
          <q-input v-model="email" label="E-mail" color="primary" type="email" />
